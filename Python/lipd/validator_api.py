...
def create_detailed_results(result):
    """
    Use the result from the API call to create an organized single string output for printing
    to the console.
...
def call_validator_api(dsn, api_data):
    ...
    :param list api_data: Prepared payload for one LiPD dataset.
        All the sorted files (txt, jsonld, csv), API formatted
    ...
    try:
        ...
        logger_validator_api.warning(
            "get_validator_results: ConnectionError: {}".format(e)
        )
        result = {
            "dat": {},
            "feedback": {},
        ...
        result = {
            ...
            "feedback": {},
            "filename": _filename,
            "status": "ERROR BEFORE VALIDATION, {}".format(e),
        }
    if not result:
        result = {
            "dat": {},
...
# Each LiPD archive array contains one JSON object per file inside of the LiPD archive
# (3 bagit txt, 1+ jsonld, 1+ csv)
sample_data_request = [
    [
        {
            "type": "bagit",
        ...
        },
        {
            ...
            "data": {
                "data": [
                    ["7.0", "OS-38364", "G. sacculifer", "2370.0", "25.0"],
                    ["102.0", "OS-38365", "G. sacculifer", "8520.0", "40.0"],
                    ["200.0", "OS-38366", "G. sacculifer", "6900.0", "35.0"],
                    ["300.0", "OS-38367", "G. sacculifer", "9710.0", "45.0"],
                    ["401.0", "OS-54863", "G. sacculifer", "14900.0", "90.0"],
                    ["427.0", "OS-54864", "G. sacculifer", "15450.0", "80.0"],
                    [""],
                ],
                "errors": [],
        ...
        },
        {
            ...
            "data": {
                ...
                "geo": {
                    "geometry": {
                        "coordinates": [125.39, -10.59, -832],
                        "type": "Point",
                    },
                    "properties": {"siteName": "MD98-2170"},
                    "type": "Feature",
                },
                "investigator": [
                    {"name": "L.D. Stott"},
        ...
        },
        {
            ...
            "data": {
                "data": [
                    ["5.0", "0.0", "-2.828", "NaN", "NaN", "NaN"],
                    ["7.5", "96.2", "-2.793", "0.169", "5.366", "29.42"],
                    ["10.0", "192.3", "-2.785", "0.154", "5.315", "29.31"],
                    ["12.5", "288.5", "-2.565", "0.415", "5.412", "29.51"],
                    ["15.0", "384.6", "-2.925", "0.005", "5.296", "29.27"],
                    ["17.5", "480.8", "-2.796", "0.139", "5.304", "29.29"],
                    ["20.0", "576.9", "-2.931", "-0.005", "5.284", "29.25"],
                    ["22.5", "673.1", "-2.955", "0.021", "5.401", "29.49"],
                    ["25.0", "769.2", "-2.879", "0.039", "5.266", "29.21"],
                    ["30.0", "961.5", "-2.983", "0.018", "5.458", "29.61"],
                    ["40.0", "1346.2", "-2.899", "0.058", "5.356", "29.4"],
                    ["50.0", "1730.8", "-2.756", "0.254", "5.477", "29.65"],
                    ["65.0", "2307.7", "-2.918", "-0.004", "5.258", "29.19"],
                    ["80.0", "2884.6", "-2.799", "0.177", "5.402", "29.49"],
                    ["90.0", "3269.2", "-2.808", "0.174", "5.413", "29.52"],
                    ["100.0", "3653.8", "-2.763", "0.072", "5.079", "28.81"],
                    ["110.0", "4038.5", "-2.81", "0.108", "5.264", "29.21"],
                    ["120.0", "4423.1", "-2.936", "0.061", "5.448", "29.59"],
                    ["130.0", "4807.7", "-2.583", "0.212", "4.996", "28.62"],
                    ["154.0", "5730.8", "-2.865", "0.138", "5.463", "29.62"],
                    ["162.0", "6038.5", "-2.757", "0.23", "5.426", "29.54"],
                    ["168.0", "6269.2", "-2.911", "0.122", "5.534", "29.76"],
                    ["174.0", "6500.0", "-2.78", "0.25", "5.53", "29.75"],
                    ["180.0", "6730.8", "NaN", "NaN", "5.494", "29.68"],
                    ["183.0", "6846.2", "-2.877", "0.122", "5.456", "29.6"],
                    ["200.0", "7203.0", "-2.833", "0.093", "5.288", "29.25"],
                    ["221.0", "7897.8", "-2.518", "0.481", "5.452", "29.6"],
                    ["240.0", "8558.3", "-2.667", "0.416", "5.655", "30.0"],
                    ["258.0", "9212.1", "-2.642", "0.374", "5.493", "29.68"],
                    ["283.0", "10165.1", "-2.563", "0.553", "5.736", "30.16"],
                    ["302.0", "10670.6", "-2.585", "0.477", "5.605", "29.9"],
                    ["308.0", "10961.6", "-2.588", "0.503", "5.676", "30.04"],
                    ["321.0", "11469.9", "-2.368", "0.598", "5.376", "29.44"],
                    ["327.0", "11728.6", "-2.552", "0.383", "5.305", "29.29"],
                    ["333.0", "12034.3", "-2.355", "0.6", "5.353", "29.39"],
                    ["340.0", "12299.5", "-2.107", "0.759", "5.151", "28.96"],
                    ["346.0", "12567.8", "-1.901", "0.909", "5.027", "28.69"],
                    ["358.0", "13159.4", "-1.868", "0.996", "5.146", "28.95"],
                    ["365.0", "13437.3", "-1.894", "0.778", "4.734", "28.03"],
                    ["377.0", "14002.0", "-1.756", "0.849", "4.601", "27.71"],
                    ["383.0", "14288.9", "-1.527", "1.072", "4.587", "27.68"],
                    ["389.0", "14578.9", "-1.024", "1.502", "4.447", "27.33"],
...
sample_data_response = [
    {
        ...
        "feedback": {
            ...
            "posMsgs": ["Valid Bagit File"],
            "errMsgs": ["Error message here"],
            "wrnMsgs": [],
        },
        "status": "PASS",
        "filename": "",
