function GTS=getLiPDGoogleColumn(GTS)
checkGoogleTokens;
for ts=1:length(GTS)
    ...
    colData=getWorksheetColumn(skey,GTS(ts).paleoData_googWorkSheetKey,whichCol,aTokenSpreadsheet);
