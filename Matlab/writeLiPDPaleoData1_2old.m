...
if isfield(LiPDStruct,'paleoData')
    ...
    for chr=1:length(LiPDStruct.paleoData)
        ...
        if isfield(LiPDStruct.paleoData{chr},'paleoMeasurementTable')
            ...
            DT=LiPDStruct.paleoData{chr}.paleoMeasurementTable;
            ...
            csvname=[goodOutName '.paleo' num2str(chr) '.paleoMeasurementTable.csv'];
            DT.filename=csvname;
            ...
            %             if m~=1
            %                 error('there should only be one paleoMeasurementTable per paleoology')
            %             end
            NLS.paleoData=DT;
        ...
        LiPDStruct.paleoData{chr}.paleoMeasurementTable=NLS.paleoData;
        ...
        if isfield(LiPDStruct.paleoData{chr},'paleoModel')
            ...
            for cm = 1:length(LiPDStruct.paleoData{chr}.paleoModel)
                ...
                if isfield(LiPDStruct.paleoData{chr}.paleoModel{cm},'summaryTable')
                    ...
                    LiPDStruct.paleoData{chr}.paleoModel{cm}.summaryTable=NLS.paleoData;
                end
